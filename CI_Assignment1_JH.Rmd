...
Both data science and causal inference seek to tell stories using data. The main difference between the two feilds is that causal inference seeks to specifically find causal relationships whereas data science has more broad applications.

2B. Briefly a predominantly data science research project and a predominantly causal inference research project.
A predominately data science research project will start out with a testable question that does not necessary have to search for a causal effect. Next, data will be collected and turned into a useable form. Then, analysis will be performed on the dataset and conclusions will be drawn. A predominately causal inference research project asks a specific question regarding a causal connection between variables.
